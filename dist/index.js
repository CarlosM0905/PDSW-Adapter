...
window.onload = () => {
    ...
    let debtInput = document.getElementById('debtInput');
    let foundsInput = document.getElementById('foundsInput');
    let verifyButton = document.getElementById('btnVerify');
    verifyButton.addEventListener('click', verifyBankOne);
    let nameInput2 = document.getElementById('nameInput2');
    let debtInput2 = document.getElementById('debtInput2');
    let foundsInput2 = document.getElementById('foundsInput2');
    let verifyButton2 = document.getElementById('btnVerify2');
    verifyButton2.addEventListener('click', verifyBankTwo);
    let dataName = document.getElementById('data-name');
    let dataTotalClients = document.getElementById('data-totalClients');
    let dataTotalFounds = document.getElementById('data-totalFounds');
    let dataYear = document.getElementById('data-year');
    let dataName2 = document.getElementById('data-name2');
    let dataTotalClients2 = document.getElementById('data-totalClients2');
    let dataTotalFounds2 = document.getElementById('data-totalFounds2');
    let dataYear2 = document.getElementById('data-year2');
    let listClients = document.getElementById('list-clients');
    let listClients2 = document.getElementById('list-clients2');
    let dataBank1 = document.getElementById('bank-one');
    let dataBank2 = document.getElementById('bank-two');
    let information = document.getElementById('information');
    let btnBankOne = document.getElementById('bank-one-btn');
    let btnBankTwo = document.getElementById('bank-two-btn');
    let btnInfo = document.getElementById('info-btn');
    ...
    function createCardClient(client) {
    ...
    function listClientsBankOne() {
        let clients = bank1.getClients();
        clients.forEach(client => {
            let clientCard = createCardClient(client);
            listClients.appendChild(clientCard);
        });
    }
    function listClientsBankTwo() {
        let clients = bank2.getClients();
        clients.forEach(client => {
            let clientCard = createCardClient(client);
    ...
    function verifyBankOne() {
        ...
        let client = new Client(nameClient, debtClient, foundsClient);
    ...
    function infoBankOne() {
        let infoBankOne = bank1.getDataBank();
    ...
    function infoBankTwo() {
        let infoBankTwo = bank2.getDataBank();
